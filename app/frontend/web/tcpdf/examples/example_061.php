...
$html = '<h2>HTML TABLE-test:</h2>
<table border="1" cellspacing="0" cellpadding="0">
	<tr style="text-align:center;line-height:15px;">
		<td>1A</td>
		<td rowspan="2" colspan="2" valign="middle" align="center" style="vertical-align: middle">vertical alignment test - should be in the middle</td>
		<td>4D</td>
	</tr>
	<tr>
		<td>1B</td>
